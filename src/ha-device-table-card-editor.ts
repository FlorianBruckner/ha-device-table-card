              ...
              ${
                columns.length > 0
                  ? html`<span
                      ...
                      style="font-size: 0.75em; background-color: var(--secondary-background-color, #e0e0e0); color: var(--primary-text-color, #000); border: 1px solid var(--divider-color, #ccc); padding: 1px 6px; border-radius: 10px; font-weight: normal;"
                      >(${columns.length})</span
                    >`
                  : ''
              }
                    ...
                    col.type === 'entity' || col.type === 'meta'
                      ? html`
                          <div class="highlights-editor">
                            ...
                            ${
                              (col.highlight || []).length === 0
                                ? html`
                                    <div
                                      class="empty-highlights-hint"
                                      style="font-size: 0.8em; font-style: italic; color: var(--secondary-text-color, #727272); margin-top: 4px; margin-bottom: 4px;"
                                    >
                                      No threshold rules configured. Click "+ Add Rule" to highlight
                                      values (e.g. red if battery is below 15%).
                                    </div>
                                  `
